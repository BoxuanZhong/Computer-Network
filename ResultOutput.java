...
public class ResultOutput {
	...
	{
		File filedata = new File ("D:/ECE570/ECE570project/EvaluationFiles/" + "data_of_node" + n);       //File path
		File fileresult = new File ("D:/ECE570/ECE570project/EvaluationFiles/" + "result_of_node" + n);
